...
public class NoteController {
	...
	*/
	...
	public String handler1(HttpServletResponse response, HttpServletRequest request,ModelMap modelMap){
		//ModelMap modelMap=new ModelMap();
		String noteId=request.getParameter("noteId");
		String noteTitle=request.getParameter("Title");
		String noteContent=request.getParameter("Content");
		String noteStatus=request.getParameter("Status");
	...
	*/
	...
	public String handler2(int noteId){
